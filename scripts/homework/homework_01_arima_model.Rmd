...
- **Justification:** Small sample size, parsimony, residuals pass Ljung–Box test, no systematic patterns in ACF/PACF, BIC preference
...
```
  ...
  Observations outside ±3 standard deviations may indicate outliers or temporary shocks.
